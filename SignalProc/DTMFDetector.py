...
class DTMFDetector:
    def __init__(self,
                 ...
                 sep_db: float = 15.0,       # separations-tærskel
                 dom_db: float = 15.0,       # dominans-tærskel
                 snr_db: float = 15.0,       # SNR-tærskel
                 twist_pos_db: float = +12.0,   # positiv twist grænse (row > col)
                 twist_neg_db: float = -12.0):  # negativ twist grænse (col > row)
